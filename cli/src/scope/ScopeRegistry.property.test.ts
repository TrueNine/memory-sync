import type {MdxGlobalScope, OsInfo, ToolReferences, UserProfile} from '@truenine/md-compiler/globals' // Feature: compiler-integration // Property-based tests for ScopeRegistry // src/scope/ScopeRegistry.property.test.ts
