import type {ProjectConfig, RulePrompt} from '../plugins/plugin-shared'
import {matchesSeries, resolveEffectiveIncludeSeries, resolveSubSeries} from '../plugins/plugin-output-shared'
