import type {CollectedInputContext, InputPluginContext, ReadmeFileKind, ReadmePrompt, RelativePath} from '../plugins/plugin-core'
...
import {FilePathKind, PromptKind, README_FILE_KIND_MAP} from '../plugins/plugin-core'
