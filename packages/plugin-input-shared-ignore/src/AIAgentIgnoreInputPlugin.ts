...
/**
 * Input plugin that reads AI agent ignore files from shadow source project root.
 * Reads files like .kiroignore, .aiignore, .cursorignore, etc.
 * and populates aiAgentIgnoreConfigFiles in CollectedInputContext.
 */
