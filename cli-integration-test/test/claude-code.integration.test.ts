  ...
  describe("install", () => {
    it("installs claude outputs from dist content", async () => {
      ...
      await withPluginEnvironment(artifacts, fixture, async (container) => {
        ...
        assertDistContent(command, ["description: English dist description", "English dist command body"], ["中文源描述", "中文源命令内容"]);
        ...
        assertDistContent(rule, ["paths:", "**/*.ts", "English rule body"], ["中文规则内容"]);
      });
    });
  });
