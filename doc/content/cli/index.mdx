---
title: CLI
description: 围绕 tnmsc 命令面组织安装、项目准备、install 流程、配置字段与故障排查内容。
sidebarTitle: 概览
status: stable
---
...
这一部分围绕公开的 `tnmsc` 命令面展开。像“怎么安装”“怎么准备项目”“怎么运行 `tnmsc install`”以及“某个配置字段到底是什么意思”这类问题，都应该先从这里开始。
...
- [第一次安装流程](/docs/cli/first-sync)：按推荐顺序运行 `help`、`dry-run` 和 `tnmsc install`。
...
3. 然后按[第一次安装流程](/docs/cli/first-sync)完成一次真实运行。
