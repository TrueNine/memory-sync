...
That is expected in the current implementation. It is deprecated and no longer initializes aindex. Maintain your source directories and global config manually instead.
