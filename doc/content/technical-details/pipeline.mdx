---
title: Sync Pipeline
description: Explains how plugins declare target files, generation flow, output scopes, and cleanup behavior.
...
- Output-scope control: see [CLI / Output Scopes](/docs/cli/output-scopes)
