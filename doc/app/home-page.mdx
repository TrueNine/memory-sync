...
<main className="docs-home">
  ...
  <section className="home-hero">
    <div className="home-hero-copy">
      ...
      <div className="home-actions">
        <Link href="/docs/cli" className="hero-button hero-button-primary">
          Get Started
        </Link>
  ...
  <section className="home-section">
    <div className="section-heading">
      ...
      <p className="section-summary">Our documentation is divided into six logical pillars to help you find exactly what you need.</p>
    </div>
