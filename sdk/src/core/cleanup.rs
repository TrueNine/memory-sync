...
mod napi_binding {
  ...
  pub fn plan_cleanup(snapshot_json: String) -> napi::Result<String> {
    ...
    let result: CleanupPlan = super::plan_cleanup(snapshot).map_err(napi::Error::from_reason)?;
  ...
  #[napi(object)]
  pub struct NapiCompactDeletionTargetsResult {
    pub files: Vec<String>,
    pub dirs: Vec<String>,
  }

  #[napi]
  pub fn compact_deletion_targets(
    files: Vec<String>,
    dirs: Vec<String>,
  ) -> NapiCompactDeletionTargetsResult {
    let (compacted_files, compacted_dirs) = super::compact_deletion_targets(&files, &dirs);
    NapiCompactDeletionTargetsResult {
  ...
  pub fn plan_workspace_empty_directory_cleanup(
    ...
    NapiWorkspaceEmptyDirectoryPlan {
      empty_dirs_to_delete: super::plan_workspace_empty_directory_cleanup_simple(
        &workspace_dir,
        &files,
        &dirs,
      ),
