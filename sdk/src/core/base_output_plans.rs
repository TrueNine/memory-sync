...
use crate::core::git_discovery::{find_all_git_repos, resolve_git_info_dir};
...
mod tests {
  ...
  fn builds_agents_plan_without_prompt_source_outputs() {
    ...
    let context = CollectedInputContext {
      workspace: Some(Workspace {
        directory: crate::core::plugin_shared::RootPath::new(&workspace_dir),
        projects: vec![
          Project {
  ...
  fn builds_git_exclude_plan_for_workspace_and_project_repos() {
    ...
    let context = CollectedInputContext {
      workspace: Some(Workspace {
        directory: crate::core::plugin_shared::RootPath::new(&workspace_dir.to_string_lossy()),
