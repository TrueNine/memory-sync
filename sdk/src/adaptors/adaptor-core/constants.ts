...
export const ADAPTOR_NAMES = {
  AgentsOutput: 'AgentsOutputAdaptor',
  GeminiCLIOutput: 'GeminiCLIOutputAdaptor',
  CursorOutput: 'CursorOutputAdaptor',
  WindsurfOutput: 'WindsurfOutputAdaptor',
  ClaudeCodeCLIOutput: 'ClaudeCodeCLIOutputAdaptor',
  KiroIDEOutput: 'KiroCLIOutputAdaptor',
  OpencodeCLIOutput: 'OpencodeCLIOutputAdaptor',
  OpenAICodexCLIOutput: 'CodexCLIOutputAdaptor',
  DroidCLIOutput: 'DroidCLIOutputAdaptor',
  WarpIDEOutput: 'WarpIDEOutputAdaptor',
  TraeIDEOutput: 'TraeIDEOutputAdaptor',
  TraeCNIDEOutput: 'TraeCNIDEOutputAdaptor',
  QoderIDEOutput: 'QoderIDEPluginOutputAdaptor',
  JetBrainsCodeStyleOutput: 'JetBrainsIDECodeStyleConfigOutputAdaptor',
  JetBrainsAICodexOutput: 'JetBrainsAIAssistantCodexOutputAdaptor',
  AgentSkillsCompactOutput: 'GenericSkillsOutputAdaptor',
  GitExcludeOutput: 'GitExcludeOutputAdaptor',
  ReadmeOutput: 'ReadmeMdConfigFileOutputAdaptor',
  VSCodeOutput: 'VisualStudioCodeIDEConfigOutputAdaptor',
  ZedOutput: 'ZedIDEConfigOutputAdaptor',
  AntigravityOutput: 'AntigravityOutputAdaptor'
} as const

export type AdaptorName = (typeof ADAPTOR_NAMES)[keyof typeof ADAPTOR_NAMES]
