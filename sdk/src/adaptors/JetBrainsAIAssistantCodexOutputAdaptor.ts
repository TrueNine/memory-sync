...
export class JetBrainsAIAssistantCodexOutputAdaptor extends AbstractOutputAdaptor {
  constructor() {
    super('JetBrainsAIAssistantCodexOutputAdaptor', {
  ...
  private getJetBrainsCodexDirs(ctx: OutputAdaptorContext | OutputWriteContext | OutputCleanContext): readonly string[] {
