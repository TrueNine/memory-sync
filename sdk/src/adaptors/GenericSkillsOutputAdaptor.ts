...
import {AbstractOutputAdaptor, filterByProjectConfig} from './adaptor-core'
 ...
 */
export class GenericSkillsOutputAdaptor extends AbstractOutputAdaptor {
  constructor() {
    super('GenericSkillsOutputAdaptor', {
