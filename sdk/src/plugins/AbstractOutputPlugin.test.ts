...
import {AbstractOutputPlugin, createLogger, FilePathKind, PromptKind} from './plugin-core'

class TestDefaultPromptOutputPlugin extends AbstractOutputPlugin {
  constructor() {
    super('TestDefaultPromptOutputPlugin', {
