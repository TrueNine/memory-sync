import type {OutputCleanContext, OutputWriteContext, Project} from './plugin-core'
...
function createWriteContext(workspaceBase: string, projects: readonly Project[]): OutputWriteContext {
  return {
    logger: createLogger('GitExcludeOutputPlugin', 'error'),
    fs,
    path,
    glob: {} as never,
    dryRun: true,
...
describe('gitExcludeOutputPlugin workspace cleanup', () => {
