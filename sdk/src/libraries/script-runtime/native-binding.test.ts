...
const PLATFORM_BINDINGS: Record<string, PlatformBinding> = {
  'win32-x64': {local: 'napi-memory-sync-cli.win32-x64-msvc', suffix: 'win32-x64-msvc'},
  'linux-x64': {local: 'napi-memory-sync-cli.linux-x64-gnu', suffix: 'linux-x64-gnu'},
  'linux-arm64': {local: 'napi-memory-sync-cli.linux-arm64-gnu', suffix: 'linux-arm64-gnu'},
  'darwin-arm64': {local: 'napi-memory-sync-cli.darwin-arm64', suffix: 'darwin-arm64'},
  'darwin-x64': {local: 'napi-memory-sync-cli.darwin-x64', suffix: 'darwin-x64'}
}
